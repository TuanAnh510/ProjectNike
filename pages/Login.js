                  ...
                  <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                      ...
                      <input
                        ...
                        name="email"
                        id="email"
                        className="w-full rounded-lg p-2 border-2 border-[#e5e5e5]"
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <a
                        href="#"
                        className="text-sm font-medium text-[#8d8d8d] hover:underline"
                      >
                    ...
                    <Link href="/Confirm">
                      <button
                        type="submit"
                        className="w-full bg-black text-white rounded-[5px] text-[15px] px-5 py-2.5 text-center font-bold mt-5"
                      >
                        SIGN IN
                      </button>
                    </Link>
