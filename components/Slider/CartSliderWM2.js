...
import datasl from "/data/cartsliderWM2.json";
import Link from "next/link";
const CartSliderWM2 = ({ women }) => {
  ...
  return (
    <div>
      <div className="flex justify-between">
        <div className="text-[25px]  ">Your Pegasus Shop</div>
        <div className="pb-5 flex gap-5">
          <Link href="/Women">
            <button className="py-2 hover:text-[#b3b3b3] hidden lg:block md:hidden ">
              Shop
            </button>
          </Link>
          <span
      ...
      <div>
        <Slider
          {...settings}
          ref={sliderRef}
          className="card-finnes h-[450px] md:h-[500px] lg:h-[600px] mt-5"
        >
